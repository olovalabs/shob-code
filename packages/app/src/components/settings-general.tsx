...
export const SettingsGeneral: Component = () => {
  ...
  const [store, setStore] = createStore({ checking: false })
        ...
        const actions =
          platform.update && platform.restart
            ? [
                ...
                { label: language.t("toast.update.action.notYet"), onClick: "dismiss" as const },
              ]
            : [{ label: language.t("toast.update.action.notYet"), onClick: "dismiss" as const }]
  ...
  const languageOptions = createMemo(() =>
    language.locales.map((locale) => ({ value: locale, label: language.label(locale) })),
  )
  ...
  return (
    <div class="flex flex-col h-full overflow-y-auto no-scrollbar px-6 py-6">
      <div class="flex flex-col gap-6 max-w-2xl">
        {/* General */}
        <Section title={language.t("settings.general.section.general")}>
          <Row
        ...
        {/* Appearance */}
        <Section title={language.t("settings.general.section.appearance")}>
          <Row
        ...
        {/* Notifications */}
        <Section title={language.t("settings.general.section.notifications")}>
          <Row
        ...
        {/* Sounds */}
        <Section title={language.t("settings.general.section.sounds")}>
          <Row
        ...
        {/* Updates */}
        <Section title={language.t("settings.general.section.updates")}>
          <Row
        ...
        <Show when={linux()}>
          {(_) => {
            ...
            return (
              <Section title={language.t("settings.general.section.display")}>
                <Row
                  title={
