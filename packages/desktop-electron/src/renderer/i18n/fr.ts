export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version de Shob",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} de Shob a été téléchargée. Voulez-vous l'installer et redémarrer ?",
