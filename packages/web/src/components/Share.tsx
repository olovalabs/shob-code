...
import { Iconshob } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "shob/session/message-v2"
import type { Message } from "shob/session/message"
import type { Session } from "shob/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.shob_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.shob_name}>
                    <Iconshob width={16} height={16} />
                  </div>
