---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala shob.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

shob zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie shob uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI shob, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do shob. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Jest to oddzielny plik od `shob.json`, który konfiguruje zachowanie serwera/runtime.
...
Użyj `shob_TUI_CONFIG`, aby załadować niestandardową ścieżkę konfiguracji TUI.
