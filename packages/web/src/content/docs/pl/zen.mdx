---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez shob.
---
...
shob Zen to lista przetestowanych i zweryfikowanych modeli udostępniana przez zespół shob.

:::note
shob Zen jest obecnie w wersji beta.
:::

Zen działa jak każdy inny dostawca w shob. Logujesz się do shob Zen i otrzymujesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z shob.
:::
...
shob Zen to brama AI, która daje dostęp do tych modeli.

---

## Jak to działa

shob Zen działa jak każdy inny dostawca w shob.

1. Logujesz się do **<a href={console}>shob Zen</a>**, dodajesz dane
   rozliczeniowe i kopiujesz swój klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz shob Zen i wklejasz swój klucz API.
...
[ID modelu](/docs/config/#models) w Twojej konfiguracji shob używa formatu
`shob/<model-id>`. Na przykład dla GPT 5.3 Codex użyjesz w konfiguracji
`shob/gpt-5.3-codex`.
...
- MiniMax M2.5 Free jest dostępny w shob przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- MiMo V2 Pro Free jest dostępny w shob przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- MiMo V2 Omni Free jest dostępny w shob przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Qwen3.6 Plus Free jest dostępny w shob przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3 Super Free jest dostępny w shob przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Big Pickle to stealth model, który jest darmowy w shob przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
...
4. Nie tworzyć **lock-in**, pozwalając używać tego z dowolnym innym agentem kodującym. I zawsze pozwalać Ci używać w shob także dowolnego innego dostawcy.
