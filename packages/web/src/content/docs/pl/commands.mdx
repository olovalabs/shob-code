...
Możesz zdefiniować polecenia w `shob.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji shob:
...
- Globalnie: `~/.config/shob/commands/`
- Na projekt: `.shob/commands/`
...
shob zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
