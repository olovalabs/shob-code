---
title: TUI
description: Usando la interfaz de usuario del terminal shob.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

shob proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar shob se inicia TUI para el directorio actual.
...
Cuando utilice shob TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a shob. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Esto es independiente de `shob.json`, que configura el comportamiento del servidor/tiempo de ejecución.
...
Utilice `shob_TUI_CONFIG` para cargar una ruta de configuración de TUI personalizada.
