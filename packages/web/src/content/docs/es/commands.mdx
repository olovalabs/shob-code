...
Puede agregar comandos personalizados a través de la configuración shob o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su shob [config](/docs/config):
...
shob incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
