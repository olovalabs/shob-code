---
title: IDE
description: The shob extension for VS Code, Cursor, and other IDEs
---

shob integrates with VS Code, Cursor, or any IDE that supports a terminal. Just run `shob` in the terminal to get started.
...
To install shob on VS Code and popular forks like Cursor, Windsurf, VSCodium:

1. Open VS Code
2. Open the integrated terminal
3. Run `shob` - the extension installs automatically
...
Search for **shob** in the Extension Marketplace and click **Install**.
...
- Ensure you’re running `shob` in the integrated terminal.
