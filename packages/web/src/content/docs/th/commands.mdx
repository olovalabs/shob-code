...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ shob:
...
- ระดับผู้ใช้ (Global): `~/.config/shob/commands/`
- ระดับโปรเจ็กต์: `.shob/commands/`
...
shob มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
