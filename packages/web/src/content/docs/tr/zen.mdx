---
title: Zen
description: shob tarafından sağlanan seçilmiş modeller listesi.
---
...
shob Zen, shob ekibi tarafından test edilip doğrulanmış modellerin bir listesidir.

:::note
shob Zen şu anda beta olarak mevcut.
:::

Zen, shob'daki diğer sağlayıcılar gibi çalışır. shob Zen'de oturum açıp API anahtarınızı alırsınız. Bu **tamamen isteğe bağlıdır** ve shob kullanmak için buna ihtiyacınız yoktur.
...
:::tip
shob ile iyi çalışan seçili bir model ve sağlayıcı grubunu test ettik.
:::
...
shob Zen, bu modellere erişmenizi sağlayan bir AI ağ geçididir.

---

## Nasıl çalışır

shob Zen, shob'daki diğer sağlayıcılar gibi çalışır.

1. **<a href={console}>shob Zen</a>**'de oturum açın, faturalandırma bilgilerinizi ekleyin ve API anahtarınızı kopyalayın.
2. TUI'de `/connect` komutunu çalıştırın, shob Zen'i seçin ve API anahtarınızı yapıştırın.
...
shob yapılandırmanızdaki [model id](/docs/config/#models) `shob/<model-id>` biçimini kullanır. Örneğin, GPT 5.3 Codex için yapılandırmanızda `shob/gpt-5.3-codex` kullanırsınız.
...
- MiniMax M2.5 Free, sınırlı bir süre için shob'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- MiMo V2 Pro Free, sınırlı bir süre için shob'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- MiMo V2 Omni Free, sınırlı bir süre için shob'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Qwen3.6 Plus Free, sınırlı bir süre için shob'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Nemotron 3 Super Free, sınırlı bir süre için shob'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Big Pickle, sınırlı bir süre için shob'da ücretsiz olan gizli bir modeldir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
...
shob Zen'i şunlar için oluşturduk:
...
4. Başka herhangi bir kodlama ajanıyla kullanmanıza izin vererek **kilitlenme olmamasını** sağlamak. Ayrıca shob ile her zaman başka herhangi bir sağlayıcıyı da kullanabilmenizi sağlamak.
