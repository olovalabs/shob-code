---
title: Özel Araçlar
description: LLM'un shob'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. shob'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.shob/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/shob/tools/` içine yerleştirerek.
