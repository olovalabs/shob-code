---
title: Paylasim
description: shob konusmalarini genel baglantilarla paylasin.
---

shob'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda shob:
...
shob, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak shob manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `shob.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda shob kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
