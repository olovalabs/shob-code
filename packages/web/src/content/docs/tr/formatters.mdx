...
description: shob dile özgü biçimlendiriciler kullanır.
---

shob, dosyaları dile özgü formatlayıcılar kullanılarak yazıldıktan veya düzenlendikten sonra otomatik olarak formatlar. Bu, oluşturulan kodun projenizin kod stillerine uymasını sağlar.

---

## Yerleşik

shob, popüler diller ve çerçeveler için çeşitli yerleşik biçimlendiricilerle birlikte gelir. Aşağıda ihtiyaç duyduğu biçimlendiricilerin, desteklenen dosya uzantılarının ve komutların veya yapılandırma seçeneklerinin bir listesi bulunmaktadır.
...
Yani eğer projenizin `package.json` dosyasında `prettier` varsa, shob bunu otomatik olarak kullanacaktır.

---

## Nasıl çalışır?

shob bir dosyayı yazdığında veya düzenlediğinde:
...
Biçimlendiricileri shob yapılandırmanızdaki `formatter` bölümü aracılığıyla özelleştirebilirsiniz.
