---
title: TUI
description: Korištenje korisničkog interfejsa shob terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

shob pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje shob pokreće TUI za trenutni direktorij.
...
Kada koristite shob TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u shob. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz shob. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `shob.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
Koristite `shob_TUI_CONFIG` da učitate prilagođenu putanju TUI konfiguracije.
