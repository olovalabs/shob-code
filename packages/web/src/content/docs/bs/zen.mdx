---
title: Zen
description: Kurirana lista modela koje nudi shob.
---
...
shob Zen je lista testiranih i provjerenih modela koje pruža shob tim.

:::note
shob Zen je trenutno u beta fazi.
:::

Zen radi kao i svaki drugi provajder u shob. Prijavite se na shob Zen i
preuzmete svoj API ključ. To je **potpuno opcionalno** i ne morate ga koristiti
da biste koristili shob.
...
:::tip
Testirali smo odabranu grupu modela i provajdera koji dobro rade s shob.
:::
...
shob Zen je AI gateway koji vam daje pristup tim modelima.

---

## Kako radi

shob Zen radi kao i svaki drugi provajder u shob.

1. Prijavite se na **<a href={console}>shob Zen</a>**, dodajte podatke za
   naplatu i kopirajte svoj API ključ.
2. Pokrenite komandu `/connect` u TUI, izaberite shob Zen i zalijepite svoj API ključ.
...
[model id](/docs/config/#models) u vašoj shob konfiguraciji koristi format
`shob/<model-id>`. Na primjer, za GPT 5.3 Codex u konfiguraciji biste
koristili `shob/gpt-5.3-codex`.
...
- MiniMax M2.5 Free je dostupan na shob ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- MiMo V2 Pro Free je dostupan na shob ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- MiMo V2 Omni Free je dostupan na shob ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- Qwen3.6 Plus Free je dostupan na shob ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- Nemotron 3 Super Free je dostupan na shob ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- Big Pickle je stealth model koji je besplatan na shob ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
...
4. Obezbijedimo **bez lock-ina** time što vam omogućavamo da ga koristite s bilo kojim drugim coding agentom. I da vam uvijek omogućimo da koristite bilo koji drugi provajder i u shob.
