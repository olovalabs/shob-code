---
title: Dijeljenje
description: Dijelite shob razgovore javnim linkovima.
---

shob opcija dijeljenja vam omogucava da kreirate javne linkove za razgovore. Tako lakse saradujete s timom ili trazite pomoc od drugih.
...
shob podrzava tri nacina dijeljenja koji odreduju kako se razgovori dijele:

---

### Ručno (zadano)

Po defaultu, shob koristi rucni nacin dijeljenja. Sesije se ne dijele automatski, ali ih mozete rucno podijeliti komandom `/share`:
...
Da ovo vazi za cijeli tim u odredenom projektu, dodajte postavku u projektni `shob.json` i commitujte u Git.
...
[Saznajte vise](/docs/enterprise) o koristenju shob u organizaciji.
