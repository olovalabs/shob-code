---
title: Zen
description: Curated list of models provided by shob.
---
...
shob Zen is a list of tested and verified models provided by the shob team.

:::note
shob Zen is currently in beta.
:::

Zen works like any other provider in shob. You login to shob Zen and get
...
:::tip
We tested a select group of models and providers that work well with shob.
:::
...
shob Zen is an AI gateway that gives you access to these models.

---

## How it works

shob Zen works like any other provider in shob.

1. You sign in to **<a href={console}>shob Zen</a>**, add your billing
   details, and copy your API key.
2. You run the `/connect` command in the TUI, select shob Zen, and paste your API key.
...
The [model id](/docs/config/#models) in your shob config
uses the format `shob/<model-id>`. For example, for GPT 5.3 Codex, you would
use `shob/gpt-5.3-codex` in your config.
...
- MiniMax M2.5 Free is available on shob for a limited time. The team is using this time to collect feedback and improve the model.
- Qwen3.6 Plus Free is available on shob for a limited time. The team is using this time to collect feedback and improve the model.
- Nemotron 3 Super Free is available on shob for a limited time. The team is using this time to collect feedback and improve the model.
- Big Pickle is a stealth model that's free on shob for a limited time. The team is using this time to collect feedback and improve the model.
...
4. Have **no lock-in** by allowing you to use it with any other coding agent. And always let you use any other provider with shob as well.
