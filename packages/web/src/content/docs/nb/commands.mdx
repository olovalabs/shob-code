...
Du kan legge til egendefinerte kommandoer gjennom shob-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i shob [config](/docs/config):
...
- Globalt: `~/.config/shob/commands/`
- Per prosjekt: `.shob/commands/`
...
shob inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
