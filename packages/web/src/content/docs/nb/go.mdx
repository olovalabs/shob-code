...
shob Go er et lavkostnadsabonnement — **$5 for din første måned**, deretter **$10/måned** — som gir deg pålitelig tilgang til populære åpne kodemodeller.

:::note
shob Go er for øyeblikket i beta.
:::

Go fungerer som enhver annen leverandør i shob. Du abonnerer på shob Go og
...
shob Go gir deg tilgang til disse modellene for **$5 for din første måned**, deretter **$10/måned**.

---

## Hvordan det fungerer

shob Go fungerer som enhver annen leverandør i shob.

1. Du logger inn på **<a href={console}>shob Zen</a>**, abonnerer på Go, og
   kopierer din API-nøkkel.
2. Du kjører kommandoen `/connect` i TUI-en, velger `shob Go`, og limer inn
   din API-nøkkel.
3. Kjør `/models` i TUI-en for å se listen over modeller som er tilgjengelige gjennom Go.

:::note
Kun ett medlem per arbeidsområde kan abonnere på shob Go.
:::
...
shob Go inkluderer følgende grenser:
...
[Modell-ID-en](/docs/config/#models) i din shob-konfigurasjon
bruker formatet `shob-go/<model-id>`. For eksempel, for Kimi K2.5, vil du
bruke `shob-go/kimi-k2.5` i konfigurasjonen din.
...
4. Ha **ingen innelåsing** ved å la deg bruke en hvilken som helst annen leverandør med shob også.
