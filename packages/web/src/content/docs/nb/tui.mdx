---
title: TUI
description: Bruke shob-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

shob gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre shob starter TUI for gjeldende katalog.
...
Når du bruker shob TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til shob. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Dette er atskilt fra `shob.json`, som konfigurerer server-/kjøretidsoppførsel.
...
Bruk `shob_TUI_CONFIG` for å laste en egendefinert TUI-konfigurasjonsbane.
