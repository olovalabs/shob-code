...
Agentferdigheter lar shob oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
shob søker etter disse stedene:

- Prosjektkonfigurasjon: `.shob/skills/<name>/SKILL.md`
- Global konfigurasjon: `~/.config/shob/skills/<name>/SKILL.md`
...
For prosjektlokale stier går shob opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
Den laster alle matchende `skills/*/SKILL.md` i `.shob/` og alle matchende `.claude/skills/*/SKILL.md` eller `.agents/skills/*/SKILL.md` underveis.

Globale definisjoner lastes også inn fra `~/.config/shob/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` og `~/.agents/skills/*/SKILL.md`.
...
Lag `.shob/skills/git-release/SKILL.md` slik:
...
shob viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `shob.json`:
...
**For innebygde agenter** (i `shob.json`):
