---
title: Deling
description: Del dine shob-samtaler.
---

Delingsfunksjonen i shob lar deg lage offentlige lenker til dine shob-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
shob støtter tre delingsmoduser som kontrollerer hvordan samtaler deles:

---

### Manuell (standard)

Som standard bruker shob manuell delingsmodus. Økter deles ikke automatisk, men du kan dele dem manuelt ved å bruke kommandoen `/share`:
...
For å håndheve dette på tvers av teamet ditt for et gitt prosjekt, legg det til `shob.json` i prosjektet ditt og sjekk det inn i Git.
...
[Finn ut mer](/docs/enterprise) om bruk av shob i organisasjonen din.
