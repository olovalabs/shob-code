...
shob støtter standard proxy-miljøvariabler og tilpassede sertifikater for bedriftsnettverksmiljøer.

---

## Mellomtjener

shob respekterer standard proxy-miljøvariabler.
...
Hvis bedriften din bruker egendefinerte CA-er for HTTPS-tilkoblinger, konfigurer shob til å stole på dem.
