---
title: Zen
description: Lista selecionada de modelos fornecidos pelo shob.
---
...
O shob Zen é uma lista de modelos testados e verificados fornecidos pela equipe do shob.

:::note
O shob Zen está atualmente em beta.
:::

O Zen funciona como qualquer outro provedor no shob. Você faz login no shob Zen e recebe sua chave de API. É **completamente opcional** e você não precisa usá-lo para usar o shob.
...
:::tip
Testamos um grupo selecionado de modelos e provedores que funcionam bem com o shob.
:::
...
O shob Zen é um gateway de AI que dá a você acesso a esses modelos.

---

## Como funciona

O shob Zen funciona como qualquer outro provedor no shob.

1. Você faz login no **<a href={console}>shob Zen</a>**, adiciona seus dados de cobrança e copia sua chave de API.
2. Você executa o comando `/connect` no TUI, seleciona shob Zen e cola sua chave de API.
...
O [model id](/docs/config/#models) na sua configuração do shob usa o formato `shob/<model-id>`. Por exemplo, para GPT 5.3 Codex, você usaria `shob/gpt-5.3-codex` na sua configuração.
...
- MiniMax M2.5 Free está disponível no shob por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- MiMo V2 Pro Free está disponível no shob por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- MiMo V2 Omni Free está disponível no shob por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Qwen3.6 Plus Free está disponível no shob por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Nemotron 3 Super Free está disponível no shob por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Big Pickle é um modelo stealth que está gratuito no shob por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
...
4. Não ter **lock-in**, permitindo que você o use com qualquer outro agente de codificação. E sempre permitir que você use qualquer outro provedor com o shob também.
