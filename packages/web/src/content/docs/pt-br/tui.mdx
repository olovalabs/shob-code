---
title: TUI
description: Usando a interface de usuário de terminal shob.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

O shob fornece uma interface de terminal interativa ou TUI para trabalhar em seus projetos com um LLM.

Executar shob inicia o TUI para o diretório atual.
...
Ao usar o TUI do shob, você pode digitar `/` seguido pelo nome de um comando para executar ações rapidamente. Por exemplo:
...
Adicione um provedor ao shob. Permite que você selecione entre os provedores disponíveis e adicione suas chaves de API.
...
Isso é separado do `shob.json`, que configura o comportamento do servidor/runtime.
...
Use `shob_TUI_CONFIG` para carregar um caminho de configuração TUI personalizado.
