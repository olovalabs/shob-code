...
Puoi aggiungere comandi personalizzati tramite la config di shob o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di shob:
...
- Globale: `~/.config/shob/commands/`
- Per progetto: `.shob/commands/`
...
shob include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
