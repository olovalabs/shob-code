...
console.log("Fetching GitHub releases for anomalyco/shob...\n")
...
console.log("Fetching npm all-time downloads for shob-ai...\n")
const npmDownloads = await fetchNpmDownloads("shob-ai")
